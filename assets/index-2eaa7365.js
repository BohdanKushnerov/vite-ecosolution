...
`,wv=()=>{const[e,t]=b.useState(!1);return b.useEffect(()=>{const n=()=>{const r=window.scrollY>0;t(r)};return window.addEventListener("scroll",n),()=>{window.removeEventListener("scroll",n)}},[]),e},Sv=()=>{const e=op(768,1440),t=wv();console.log(t);const n=()=>{Kr(Pe.CONTACT)};return v.jsxs(yv,{children:[v.jsx(ip,{$scrolled:t}),v.jsxs(xv,{children:[v.jsx(vv,{}),e!=="mobile"&&v.jsx(Ol,{textContent:"Get in touch",followTo:n})]})]})},Ev=_.button`
  display: flex;
  width: 141px;
  height: 39px;
...
`,W1=({imageSrc:e,imageSrc2x:t})=>v.jsxs("picture",{children:[v.jsx("source",{srcSet:`${e} 1x, ${t} 2x`}),v.jsx(V1,{src:e})]}),H1="/vite-ecosolution/assets/lviv-region-5b359b82.webp",G1="/vite-ecosolution/assets/lviv-region-2x-96295f3b.webp",U1="/vite-ecosolution/assets/zhytomyr-city-3f6eae4f.webp",Q1="/vite-ecosolution/assets/zhytomyr-city-2x-a0538cd1.webp",Y1="/vite-ecosolution/assets/rivne-city-323c680c.webp",X1="/vite-ecosolution/assets/rivne-city-2x-a1d6bb37.webp",K1="/vite-ecosolution/assets/kherson-city-ef69295b.webp",q1="/vite-ecosolution/assets/kherson-city-2x-990e6e5b.webp",Z1="/vite-ecosolution/assets/zaporizhia-city-805bcd2f.webp",J1="/vite-ecosolution/assets/zaporizhia-city-2x-71a22a97.webp",ey=[{key:1,imageSrc:H1,imageSrc2x:G1,title:"Lviv Region, Radekhiv town Private Enterprise “ZAKHIDNYI BUH”",description:"Wind Power for auto field irrigation",date:"July 2023"},{key:2,imageSrc:U1,imageSrc2x:Q1,title:"Zhytomyr city Private Enterprise “Bosch”",description:"Solar Panels for industrial use",date:"November 2023"},{key:3,imageSrc:Y1,imageSrc2x:X1,title:"Rivne city Private Enterprise “Biotech”",description:"Thermal modules",date:"October 2023"},{key:4,imageSrc:K1,imageSrc2x:q1,title:"Kherson city Private Enterprise “HealthyFarm”",description:"Wind power",date:"September 2021"},{key:5,imageSrc:Z1,imageSrc2x:J1,title:"Zaporizhia city Private Enterprise “Biotech”",description:"Mini nuclear stations",date:"May 2021"}],ty=_.div`
  margin-top: 36px;
  margin-bottom: 24px;
...
`,Py=()=>{const[e,t]=b.useState(1),n=i=>{t(i)},r=()=>{Kr(Pe.CONTACT)};return v.jsxs(yy,{id:Pe.QUESTIONS,children:[v.jsxs(xy,{children:[v.jsx(wy,{children:"Frequently Asked Questions"}),v.jsxs(gc,{id:"not-mobile",children:[v.jsx(vc,{children:"Didn't find the answer to your question?"}),v.jsx(Ol,{textContent:"Contact Us",followTo:r})]})]}),v.jsx(Sy,{children:vy.map(i=>v.jsxs(Ey,{children:[v.jsx(ky,{onClick:()=>n(i.id),children:e===i.id?v.jsx("svg",{width:16,height:16,children:v.jsx("use",{href:ne+"#icon-minus"})}):v.jsx("svg",{width:16,height:16,children:v.jsx("use",{href:ne+"#icon-add"})})}),v.jsxs("div",{children:[v.jsx(Ty,{children:i.title}),e===i.id&&v.jsx(Cy,{children:i.answer})]})]},i.id))}),v.jsxs(gc,{id:"mobile",children:[v.jsx(vc,{children:"Didn't find the answer to your question?"}),v.jsx(Ol,{textContent:"Contact Us",followTo:r})]})]})},zy=_.form`
  display: flex;
  flex-direction: column;
  gap: 28px;
  margin-top: 36px;
...
`,jy=_.div`
  margin-top: -8px;
  margin-left: auto;
`,My=()=>v.jsxs(zy,{action:"",children:[v.jsxs(_s,{htmlFor:"fullName",children:[v.jsx(ki,{children:"* Full name:"}),v.jsx(Is,{type:"text",id:"fullName",placeholder:"John Rosie"})]}),v.jsxs(_s,{htmlFor:"email",children:[v.jsx(ki,{children:"* E-mail:"}),v.jsx(Is,{type:"email",id:"email",placeholder:"johnrosie@gmail.com"})]}),v.jsxs(_s,{htmlFor:"phone",children:[v.jsx(ki,{children:"* Phone:"}),v.jsx(Is,{type:"tel",id:"phone",placeholder:"380961234567"})]}),v.jsxs(_y,{htmlFor:"message",children:[v.jsx(ki,{children:"Message:"}),v.jsx(Iy,{id:"message",name:"message",cols:30,rows:10,placeholder:"Your message"})]}),v.jsx(jy,{children:v.jsx(sp,{type:"submit",textContent:"Send"})})]}),Oy=_.section`
  margin-top: 36px;
...
`,$y=()=>v.jsxs(Oy,{id:Pe.CONTACT,children:[v.jsx(Ly,{children:"Contact Us"}),v.jsxs(Ny,{children:[v.jsxs(Ay,{children:[v.jsxs(Ti,{children:[v.jsx(Ci,{children:"Phone:"}),v.jsxs(Ry,{children:[v.jsxs(Pi,{href:"tel:+38(093)1234567",target:"blank",children:[v.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:v.jsx("use",{href:ne+"#icon-call",stroke:"#173d33",fill:"#FFFFFF"})}),"38 (098) 12 34 567"]}),v.jsxs(Pi,{href:"tel:+38(093)1234567",target:"blank",children:[v.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:v.jsx("use",{href:ne+"#icon-call"})}),"38 (093) 12 34 567"]})]})]}),v.jsxs(Ti,{children:[v.jsx(Ci,{children:"E-mail:"}),v.jsxs(Pi,{href:"mailto:office@ecosolution.com",target:"blank",children:[v.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:v.jsx("use",{href:ne+"#icon-sms"})}),"office@ecosolution.com"]})]}),v.jsxs(Ti,{children:[v.jsx(Ci,{children:"Address:"}),v.jsxs(Pi,{href:"https://www.google.com.ua/maps/search/79005,+Ukraine,+Lvivstreet.+Shota+Rustaveli,+7/@49.8313557,24.0323843,17z/data=!3m1!4b1?entry=ttu",target:"blank",children:[v.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:v.jsx("use",{href:ne+"#icon-map"})}),"79005, Ukraine, Lvivstreet. Shota Rustaveli, 7"]})]}),v.jsxs(Ti,{children:[v.jsx(Ci,{children:"Social Networks:"}),v.jsx($a,{colorplan:"primary",space:32})]})]}),v.jsx(My,{})]})]}),by=_.footer`
  width: 320px;
  flex-shrink: 0;
  margin-top: 36px;
  padding: 24px 0;
...
`,Hy=()=>{const e=()=>{Kr(Pe.MAIN)};return v.jsxs(by,{children:[v.jsxs(Dy,{children:[v.jsx(ip,{}),v.jsx(Fy,{children:v.jsx($a,{colorplan:"primary",space:8})}),v.jsx(By,{onClick:e,children:v.jsx("svg",{width:16,height:16,children:v.jsx("use",{href:ne+"#icon-arrow-right"})})})]}),v.jsxs(Vy,{children:[v.jsxs(Wy,{children:[v.jsx("p",{children:"79005, Ukraine, Lvivstreet. Shota Rustaveli, 7"}),v.jsx("p",{children:"office@ecosolution.com"})]}),v.jsx("p",{children:"ecosolution © 2023"})]})]})};const Gy="/vite-ecosolution/assets/fira-sans-v17-latin-300-f8fb86af.woff2",Uy="/vite-ecosolution/assets/fira-sans-v17-latin-regular-89ae1743.woff2",Qy="/vite-ecosolution/assets/fira-sans-v17-latin-500-c52b9a30.woff2",Yy="/vite-ecosolution/assets/oswald-v53-latin-regular-24df88e7.woff2",Xy="/vite-ecosolution/assets/oswald-v53-latin-700-6ecd2a10.woff2",Ky="/vite-ecosolution/assets/oswald-v53-latin-500-201dc695.woff2",qy="/vite-ecosolution/assets/CASaygonText-Regular-b26b980e.woff2",Zy="/vite-ecosolution/assets/All-Round-Gothic-Medium-5c9e64b8.woff2",Jy="/vite-ecosolution/assets/inter-v13-latin-regular-2301bb03.woff2",dt={FiraSans_300:Gy,FiraSans_Regular:Uy,FiraSans_500:Qy,Oswald_Regular:Yy,Oswald_700:Xy,Oswald_500:Ky,CASaygonText_Regular:qy,AllRoundGothic_Medium:Zy,Inter_Regular:Jy},ex=Qg`
@font-face {
  font-family: 'Fira Sans';
...
`,tx=()=>v.jsxs(v.Fragment,{children:[v.jsx(ex,{}),v.jsxs(Xg,{children:[v.jsx(Sv,{}),v.jsx(Bv,{}),v.jsx(r0,{}),v.jsx(c0,{}),v.jsx(gy,{}),v.jsx(Py,{}),v.jsx($y,{}),v.jsx(Hy,{})]})]});js.createRoot(document.getElementById("root")).render(v.jsx(H.StrictMode,{children:v.jsx(tx,{})}));
