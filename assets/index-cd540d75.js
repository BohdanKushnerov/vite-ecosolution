...
`,Xg=({children:e})=>g.jsx(Yg,{children:e}),ne="/vite-ecosolution/assets/sprite-7a3f5b15.svg",Kg=P.a`
  display: flex;
  align-items: center;
  gap: 4px;
  cursor: pointer;
...
`,Jg=P.span`
  ...
  line-height: 9px;
  letter-spacing: -0.4px;
`,ip=({$scrolled:e})=>g.jsxs(Kg,{href:"/",target:"blank",$scrolled:e??null,children:[g.jsx("svg",{width:31,height:18,children:g.jsx("use",{href:ne+"#icon-logo"})}),g.jsx(qg,{children:"ecosolution"}),g.jsxs(Zg,{children:[g.jsx(Jg,{children:"green"}),"ergy for life"]})]}),ev=P.button`
  display: inline-flex;
  padding: 10px 16px;
...
`,Ol=({textContent:e,followTo:t})=>g.jsxs(ev,{onClick:t,children:[e,g.jsx("svg",{width:14,height:14,children:g.jsx("use",{href:ne+"#icon-group-31"})})]}),tv=e=>{b.useEffect(()=>{const t=n=>{n.code==="Escape"&&e()};return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}},[e])},nv=P.div`
  position: absolute;
  top: 0;
  left: 0;
  z-index: 3;
...
`,rv=({handleToggleModal:e,children:t})=>{tv(e);const n=r=>{r.target===r.currentTarget&&e()};return g.jsx(nv,{onClick:n,className:"absolute top-0 left-0 z-10 w-screen h-screen bg-transparent",children:t})},iv=P.button`
  display: flex;
...
`,lv=({handleToggleModal:e})=>g.jsx(iv,{onClick:e,children:g.jsxs(ov,{children:[g.jsx("svg",{width:20,height:20,children:g.jsx("use",{href:ne+"#icon-close-menu"})}),g.jsx(sv,{children:"close"})]})}),Kr=e=>{const t=document.getElementById(e);t&&window.scrollTo({top:t.offsetTop-76,behavior:"smooth"})},av=P.button`
  display: flex;
  align-items: center;
  gap: 4px;
...
`,uv=({label:e,sectionName:t,handleToggleModal:n})=>{const r=()=>{Kr(t),n()};return g.jsxs(av,{onClick:r,children:[e,g.jsx("svg",{width:16,height:16,children:g.jsx("use",{xlinkHref:ne+"#icon-arrow-right-up"})})]})},cv=P.div`
  display: flex;
  gap: ${({$space:e})=>`${e}px`};
`,lc=P.svg`
  cursor: pointer;
...
`,$a=({colorplan:e,space:t})=>g.jsxs(cv,{$space:t,children:[g.jsx("a",{href:"https://www.facebook.com/",target:"blank",children:g.jsx(lc,{width:24,height:24,$colorplan:e,children:g.jsx("use",{href:ne+"#icon-facebook"})})}),g.jsx("a",{href:"https://www.instagram.com/",target:"blank",children:g.jsx(lc,{width:24,height:24,$colorplan:e,children:g.jsx("use",{href:ne+"#icon-instagram"})})})]}),Pe={MAIN:"main",ABOUT:"about",CASES:"cases",QUESTIONS:"questions",CONTACT:"contact"},dv=[{id:1,label:"Main",sectionName:Pe.MAIN},{id:2,label:"About",sectionName:Pe.ABOUT},{id:3,label:"Cases",sectionName:Pe.CASES},{id:4,label:"FAQ",sectionName:Pe.QUESTIONS},{id:5,label:"Contact",sectionName:Pe.CONTACT}],fv=P.div`
  position: absolute;
  top: 36px;
  display: flex;
  flex-direction: column;
...
`,mv=({handleToggleModal:e})=>g.jsx(rv,{handleToggleModal:e,children:g.jsxs(fv,{children:[g.jsx(lv,{handleToggleModal:e}),g.jsx(pv,{children:dv.map(t=>g.jsx(uv,{label:t.label,sectionName:t.sectionName,handleToggleModal:e},t.id))}),g.jsx(hv,{children:g.jsx($a,{colorplan:"secondary",space:8})})]})}),gv=P.button`
  display: inline-flex;
  justify-content: center;
  align-items: center;
  flex-shrink: 0;
...
`,vv=()=>{const[e,t]=b.useState(!1),n=()=>{t(r=>!r)};return g.jsxs("div",{children:[g.jsx(gv,{onClick:n,children:g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-menu",stroke:"#292D32"})})}),e&&g.jsx(mv,{handleToggleModal:n})]})},op=(e,t)=>{const n=b.useCallback(()=>window.innerWidth<e?"mobile":window.innerWidth<t?"tablet":"desktop",[t,e]),[r,i]=b.useState(()=>n());return b.useEffect(()=>{const o=()=>i(n());return window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)},[n]),r},yv=P.header`
  position: fixed;
  top: 0;
  z-index: 2;
  display: flex;
...
`,kv=P.span`
  ...
  border-radius: 100px;
  background: #97d28b;
`,sp=({type:e,textContent:t,followTo:n})=>g.jsxs(Ev,{type:e,onClick:n,children:[t,g.jsx(kv,{children:g.jsx("svg",{width:14,height:14,children:g.jsx("use",{href:ne+"#icon-arrow-right"})})})]}),Tv=P.section`
  margin-top: 222px;
...
`,Nv="/vite-ecosolution/assets/turbine-mob-0dfea615.webp",Av="/vite-ecosolution/assets/turbine-2xmob-40a58984.webp",Rv="/vite-ecosolution/assets/turbine-tabl-dbe8aade.webp",$v="/vite-ecosolution/assets/turbine-2xtabl-344a54f0.webp",bv="/vite-ecosolution/assets/turbine-desk-43d5d924.webp",Dv="/vite-ecosolution/assets/turbine-2xdesk-c8e6de3f.webp",Fv=()=>g.jsxs("picture",{children:[g.jsx("source",{srcSet:`${Nv} 1x, ${Av} 2x`,media:"(max-width: 767px)"}),g.jsx("source",{srcSet:`${Rv} 1x, ${$v} 2x`,media:"(min-width: 768px) and (max-width: 1439px)"}),g.jsx("source",{srcSet:`${bv} 1x, ${Dv} 2x`,media:"(min-width: 1440px)"}),g.jsx("img",{src:"/src/assets/AboutSectionImages/turbine-desk.webp",alt:"turbine"})]}),Bv=()=>{const e=()=>{Kr(Pe.CASES)};return g.jsxs(Tv,{id:Pe.MAIN,children:[g.jsxs(Cv,{children:[g.jsx(Pv,{children:"renewable energy for any task"}),g.jsxs(zv,{children:[g.jsx(_v,{children:"Development and implementation of renewable non-polluting energy sources, generating power generation using energy wind, sun, water, biomass"}),g.jsx(sp,{type:"button",textContent:"Learn More",followTo:e})]})]}),g.jsxs(Iv,{children:[g.jsxs(jv,{children:[g.jsx(Mv,{children:"79005, Ukraine, Lvivstreet. Shota Rustaveli, 7"}),g.jsx(Ov,{children:"office@ecosolution.com"})]}),g.jsx(Lv,{children:"ecosolution © 2023"})]}),g.jsx(Fv,{})]})},Vv=P.section`
  display: flex;
  flex-direction: column;
  gap: 36px;
  margin-top: 36px;
...
`,Qv="/vite-ecosolution/assets/wind-farms-tabl-f682e3a7.webp",Yv="/vite-ecosolution/assets/wind-farms-2xtabl-2a8c5771.webp",Xv="/vite-ecosolution/assets/wind-farms-desk-c8152f55.webp",Kv="/vite-ecosolution/assets/wind-farms-2xdesk-837e6b69.webp",qv=()=>g.jsxs("picture",{children:[g.jsx("source",{srcSet:`${Qv} 1x, ${Yv} 2x`,media:"(min-width: 768px) and (max-width: 1439px)"}),g.jsx("source",{srcSet:`${Xv} 1x, ${Kv} 2x`,media:"(min-width: 1440px)"}),g.jsx("img",{src:"/src/assets/AboutSectionImages/Values/wind-farms-desk.webp",alt:"wind-farms"})]}),Zv="/vite-ecosolution/assets/solar-panels-tabl-ef4daad0.webp",Jv="/vite-ecosolution/assets/solar-panels-2xtabl-6d126731.webp",e0="/vite-ecosolution/assets/solar-panels-desk-40346a35.webp",t0="/vite-ecosolution/assets/solar-panels-2xdesk-99c6706c.webp",n0=()=>g.jsxs("picture",{children:[g.jsx("source",{srcSet:`${Zv} 1x, ${Jv} 2x`,media:"(min-width: 768px) and (max-width: 1439px)"}),g.jsx("source",{srcSet:`${e0} 1x, ${t0} 2x`,media:"(min-width: 1440px)"}),g.jsx("img",{src:"/src/assets/AboutSectionImages/Values/wind-farms-desk.webp",alt:"solar-panels"})]}),r0=()=>g.jsxs(Vv,{id:Pe.ABOUT,children:[g.jsxs(Wv,{children:[g.jsx(Hv,{children:"Main values of our company"}),g.jsx(Gv,{children:"EcoSolution envisions a world where sustainable energy solutions power a brighter and cleaner future for all. We aspire to be at the forefront of the global shift towards renewable energy, leading the way in innovative technologies that harness the power of nature to meet the world's energy needs."})]}),g.jsxs(Uv,{children:[g.jsxs(vi,{children:[g.jsxs(yi,{children:[g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-maximize-circle",fill:"transparent",stroke:"#173D33"})}),g.jsx(xi,{children:"Openness"})]}),g.jsx(wi,{children:"to the world, people, new ideas and projects"})]}),g.jsxs(vi,{children:[g.jsxs(yi,{children:[g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-global-edit",fill:"transparent",stroke:"#173D33"})}),g.jsx(xi,{children:"Responsibility"})]}),g.jsx(wi,{children:"we are aware that the results of our work have an impact on our lives and the lives of future generations"})]}),g.jsxs(ac,{children:[g.jsx(qv,{}),";"]}),g.jsx(ac,{children:g.jsx(n0,{})}),g.jsxs(vi,{children:[g.jsxs(yi,{children:[g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-cpu-charge",fill:"transparent",stroke:"#173D33"})}),g.jsx(xi,{children:"Innovation"})]}),g.jsx(wi,{children:"we use the latest technology to implement non-standard solutions"})]}),g.jsxs(vi,{children:[g.jsxs(yi,{children:[g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-ranking",fill:"transparent",stroke:"#173D33"})}),g.jsx(xi,{children:"Quality"})]}),g.jsx(wi,{children:"we do not strive to be the first among others, but we want to be the best in our business"})]})]})]}),i0=()=>{const[e,t]=b.useState(1134147814),n=b.useRef(null);return b.useEffect(()=>(n.current=setInterval(()=>{t(r=>r+=1)},1e3),()=>{n.current&&clearInterval(n.current)}),[]),e},o0=e=>e.toString().replace(/\B(?=(\d{3})+(?!\d))/g,"."),s0=P.section`
  margin-top: 36px;
...
`,_y=()=>{const[e,t]=b.useState(1),n=i=>{t(i)},r=()=>{Kr(Pe.CONTACT)};return g.jsxs(wy,{id:Pe.QUESTIONS,children:[g.jsxs(Sy,{children:[g.jsx(Ey,{children:"Frequently Asked Questions"}),g.jsxs(gc,{id:"not-mobile",children:[g.jsx(vc,{children:"Didn't find the answer to your question?"}),g.jsx(Ol,{textContent:"Contact Us",followTo:r})]})]}),g.jsx(ky,{children:xy.map(i=>g.jsxs(Ty,{children:[g.jsx(Cy,{onClick:()=>n(i.id),children:e===i.id?g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-minus"})}):g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-add"})})}),g.jsxs("div",{children:[g.jsx(Py,{children:i.title}),e===i.id&&g.jsx(zy,{children:i.answer})]})]},i.id))}),g.jsxs(gc,{id:"mobile",children:[g.jsx(vc,{children:"Didn't find the answer to your question?"}),g.jsx(Ol,{textContent:"Contact Us",followTo:r})]})]})},Iy=P.form`
  display: flex;
  flex-direction: column;
  gap: 28px;
  margin-top: 36px;
...
`,Oy=P.div`
  margin-top: -8px;
  margin-left: auto;
`,Ly=()=>g.jsxs(Iy,{action:"/path",children:[g.jsxs(_s,{htmlFor:"fullName",children:[g.jsx(ki,{children:"* Full name:"}),g.jsx(Is,{type:"text",id:"fullName",placeholder:"John Rosie"})]}),g.jsxs(_s,{htmlFor:"email",children:[g.jsx(ki,{children:"* E-mail:"}),g.jsx(Is,{type:"email",id:"email",placeholder:"johnrosie@gmail.com"})]}),g.jsxs(_s,{htmlFor:"phone",children:[g.jsx(ki,{children:"* Phone:"}),g.jsx(Is,{type:"tel",id:"phone",placeholder:"380961234567"})]}),g.jsxs(jy,{htmlFor:"message",children:[g.jsx(ki,{children:"Message:"}),g.jsx(My,{id:"message",name:"message",cols:30,rows:10,placeholder:"Your message"})]}),g.jsx(Oy,{children:g.jsx(sp,{type:"submit",textContent:"Send"})})]}),Ny=P.section`
  margin-top: 36px;
...
`,Dy=()=>g.jsxs(Ny,{id:Pe.CONTACT,children:[g.jsx(Ay,{children:"Contact Us"}),g.jsxs(Ry,{children:[g.jsxs($y,{children:[g.jsxs(Ti,{children:[g.jsx(Ci,{children:"Phone:"}),g.jsxs(by,{children:[g.jsxs(Pi,{href:"tel:+38(093)1234567",target:"blank",children:[g.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:g.jsx("use",{href:ne+"#icon-call",stroke:"#173d33",fill:"#FFFFFF"})}),"38 (098) 12 34 567"]}),g.jsxs(Pi,{href:"tel:+38(093)1234567",target:"blank",children:[g.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:g.jsx("use",{href:ne+"#icon-call"})}),"38 (093) 12 34 567"]})]})]}),g.jsxs(Ti,{children:[g.jsx(Ci,{children:"E-mail:"}),g.jsxs(Pi,{href:"mailto:office@ecosolution.com",target:"blank",children:[g.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:g.jsx("use",{href:ne+"#icon-sms"})}),"office@ecosolution.com"]})]}),g.jsxs(Ti,{children:[g.jsx(Ci,{children:"Address:"}),g.jsxs(Pi,{href:"https://www.google.com.ua/maps/search/79005,+Ukraine,+Lvivstreet.+Shota+Rustaveli,+7/@49.8313557,24.0323843,17z/data=!3m1!4b1?entry=ttu",target:"blank",children:[g.jsx("svg",{width:24,height:24,stroke:"#173d33",fill:"transparent",children:g.jsx("use",{href:ne+"#icon-map"})}),"79005, Ukraine, Lvivstreet. Shota Rustaveli, 7"]})]}),g.jsxs(Ti,{children:[g.jsx(Ci,{children:"Social Networks:"}),g.jsx($a,{colorplan:"primary",space:32})]})]}),g.jsx(Ly,{})]})]}),Fy=P.footer`
  width: 320px;
  flex-shrink: 0;
  margin-top: 36px;
  padding: 24px 0;
...
`,Uy=()=>{const e=()=>{Kr(Pe.MAIN)};return g.jsxs(Fy,{children:[g.jsxs(By,{children:[g.jsx(ip,{}),g.jsx(Vy,{children:g.jsx($a,{colorplan:"primary",space:8})}),g.jsx(Wy,{onClick:e,children:g.jsx("svg",{width:16,height:16,children:g.jsx("use",{href:ne+"#icon-arrow-right"})})})]}),g.jsxs(Hy,{children:[g.jsxs(Gy,{children:[g.jsx("p",{children:"79005, Ukraine, Lvivstreet. Shota Rustaveli, 7"}),g.jsx("p",{children:"office@ecosolution.com"})]}),g.jsx("p",{children:"ecosolution © 2023"})]})]})};const Qy="/vite-ecosolution/assets/fira-sans-v17-latin-300-f8fb86af.woff2",Yy="/vite-ecosolution/assets/fira-sans-v17-latin-regular-89ae1743.woff2",Xy="/vite-ecosolution/assets/fira-sans-v17-latin-500-c52b9a30.woff2",Ky="/vite-ecosolution/assets/oswald-v53-latin-regular-24df88e7.woff2",qy="/vite-ecosolution/assets/oswald-v53-latin-700-6ecd2a10.woff2",Zy="/vite-ecosolution/assets/oswald-v53-latin-500-201dc695.woff2",Jy="/vite-ecosolution/assets/CASaygonText-Regular-b26b980e.woff2",ex="/vite-ecosolution/assets/All-Round-Gothic-Medium-5c9e64b8.woff2",tx="/vite-ecosolution/assets/inter-v13-latin-regular-2301bb03.woff2",dt={FiraSans_300:Qy,FiraSans_Regular:Yy,FiraSans_500:Xy,Oswald_Regular:Ky,Oswald_700:qy,Oswald_500:Zy,CASaygonText_Regular:Jy,AllRoundGothic_Medium:ex,Inter_Regular:tx},nx=Qg`
@font-face {
  font-family: 'Fira Sans';
...
`,rx=()=>g.jsxs(g.Fragment,{children:[g.jsx(nx,{}),g.jsxs(Xg,{children:[g.jsx(Sv,{}),g.jsxs("main",{children:[g.jsx(Bv,{}),g.jsx(r0,{}),g.jsx(d0,{}),g.jsx(yy,{}),g.jsx(_y,{}),g.jsx(Dy,{})]}),g.jsx(Uy,{})]})]});js.createRoot(document.getElementById("root")).render(g.jsx(H.StrictMode,{children:g.jsx(rx,{})}));
